...
# --- FOTOĞRAF ALANI (TAM ÇUBUĞUN ÜSTÜNDE) ---
# Burada bir boşluk bırakmıyoruz ki chat_input'a yapışık dursun
with st.container():
    # Popover (Açılır Baloncuk) kullanarak yer tasarrufu yapıyoruz
    with st.popover("➕ Fotoğraf Ekle", use_container_width=True):
